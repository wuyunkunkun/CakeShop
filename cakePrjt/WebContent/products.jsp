			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<!-- 结账 -->
						...
						<p><a href="${ctx }/cake/deletecart5" class="simpleCart_empty">Empty cart</a></p>
...
<!--products-->
			...
			<div class="col-md-9 product-model-sec">
				...
				<div class="product-grid">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=1 name="cake" >
							<button  class="item_add items" name="add">
									Add
							</button>
							</form>
							<div class="clearfix"> </div>
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m2.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button>View</button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=5 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>						
					</div>
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m3.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=9 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>						
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m4.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=12 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>							
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m5.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=16 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>							
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m6.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=20 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>						
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m7.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=24 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>						
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m8.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=28 name="cake" >
							<input type="submit" class="item_add items" value="Add" name="add">
							</form>
							<div class="clearfix"> </div>
						</div>							
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/static/images/m9.png" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button> View </button>
							</h4>
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=31 name="cake" >
							<button  class="item_add items" name="add">
									Add
							</button>
							</form>
			...
			<div class="col-md-3 rsidebar span_1_of_left">
					...
					<div class="product_right">
						...
						<div class="tab1">
							...
							<div class="single-bottom">						
								<a href="${ctx }/cake/Cassata"><p>Cassata</p></a>
								<a href="${ctx }/cake/Cheesecake"><p>Cheesecake</p></a>
								<a href="${ctx }/cake/Coconutcake"><p>Coconut cake</p></a>
								<a href="${ctx }/cake/Cupcake"><p>Cupcake</p></a>
						    </div>
					    </div>						  
						<div class="tab2">
							<ul class="place">								
							...
							<div class="clearfix"> </div>
							<div class="single-bottom">						
								<a href="${ctx }/cake/DeliciousCakes"><p>Delicious Cakes</p></a>
								<a href="${ctx }/cake/Gingerbread"><p>Gingerbread</p></a>									
						    </div>
					    </div>
						<div class="tab3">
							<ul class="place">								
							...
							<div class="clearfix"> </div>
							<div class="single-bottom">						
								<a href="${ctx }/cake/MileCakes"><p>Milk Cakes</p></a>
								<a href="${ctx }/cake/FruitsCakes"><p>Fruits Cakes</p></a>
						    </div>
					    </div>
						<div class="tab4">
							<ul class="place">								
							...
							<div class="clearfix"> </div>
							<div class="single-bottom">						
								<a href="${ctx }/cake/Twist4tier"><p>Twist 4 tier</p></a>
								<a href="#"><p>Floral Tier</p></a>
								<a href="${ctx }/cake/list"><p>Double Heartshape</p></a>
						    </div>
					    </div>
						<!--script-->
						<script>
				...
				<section  class="sky-form">
					...
					<div class="row row1 scroll-pane">
						...
						<div class="col col-4">
						<form action="${ctx }/cake/selectType">
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Cassata"><i></i><a href="${ctx }/cake/selectType">Chocolate</a></label>
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Cheesecake"><i></i>Butterscotch</label>
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Cupcake"><i></i>Strawberry</label>
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Fruits Cakes"><i></i>Black Forest</label>
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Coconut cake"><i></i>Mixed Fruit</label>
							<label class="checkbox"><input type="checkbox" name="checkbox1" value="Delicious Cakes"><i></i>Honey</label>
						</form>
						</div>
					</div>
				</section>
	...
	<div class="col-md-9 product-model-sec">
				...
				<a href="PageDivide?pageIndex=${cake.pageIndex }">${cake.pageIndex }</a>
				</c:forEach>
