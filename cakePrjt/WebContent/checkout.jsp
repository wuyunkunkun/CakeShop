...
<body>
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<div class="cart-box">
						...
						<p><a href="${ctx }/cake/deletecart" class="simpleCart_empty">Empty cart</a></p>
	...
	<c:forEach var="cart" items="${cartDisplay }">
			<div class="cart-header">
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						 <img src="${ctx }/${cart.img1}" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
						<h3><a href="#"> ${cart.cakeName }</a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p>${cart.discount }</p></li>
						</ul>
						<ul class="qty">
							<li><p>num</p></li>
							<li><p>${cart.num }</p></li>
						...
						<div>
							<form action="${ctx }/cake/deleteOnlycart">
							<input type="hidden" value="${cart.cakeName }" name="onlyDelete">
							<input type="submit" name="delete" value="delete"/>
							</form>
						</div>
						<div class="delivery">
							<p>Service Charges : ${cart.discountprice }</p>
