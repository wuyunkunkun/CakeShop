...
<body>
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<div class="cart-box">
						...
						<p><a href="${ctx }/cake/deletecart3" class="simpleCart_empty">Empty cart</a></p>
	...
	<div class="banner">
		<div class="container">
			...
			<a href="${ctx }/products.jsp">SHOP NOW</a>
		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-8 gallery-grid glry-one">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g1.jpg" class="img-responsive" alt=""/>
				...
				<div class="col-md-4 gallery-grid glry-two">
					<a href="${ctx }/products.jsp"><img src="static/images/g2.jpg" class="img-responsive" alt=""/>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g3.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g4.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g5.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g6.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g7.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g8.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g9.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
				...
				<div class="col-md-3 gallery-grid ">
					<a href="${ctx }/products.jsp"><img src="${ctx }/static/images/g10.png" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${ctx }/single.jsp">SHOP NOW</a>
							<div class="clearfix"> </div>
