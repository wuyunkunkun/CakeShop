			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<div class="cart-box">
						...
						<p><a href="${ctx }/cake/deletecart6" class="simpleCart_empty">Empty cart</a></p>
			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${ctx }/static/images/s1.png">
								<div class="thumb-image"> <img src="${ctx }/static/images/s1.png" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${ctx }/static/images/s2.png">
								 <div class="thumb-image"> <img src="${ctx }/static/images/s2.png" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${ctx }/static/images/s3.png">
							   <div class="thumb-image"> <img src="${ctx }/static/images/s3.png" data-imagezoom="true" class="img-responsive"> </div>
							</li> 
						</ul>
					</div>
				</div>	
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					...
					<form action="${ctx }/cake/singlecart">
					<p class="qty"> Qty :  </p><input min="1" type="number" id="quantity" name="num" value="1" class="form-control input-small">
					<div class="btn_form">
						<input type="submit" class="add-cart item_add" value="ADD TO CART"/>
					</div>
					<input type="hidden" value=1 name="cakeId"/>
					</form>
					<div class="tag">
				...
				<div class="col-md-4 single-grid1">
					...
					<ul>
						...
						<li><a href="${ctx }/products.jsp">New products</a></li>
						<li><a href="${ctx }/account.jsp">Register</a></li>
						<li><a href="${ctx }/account.jsp">Forgot Your Password</a></li>
						<li><a href="${ctx }/account.jsp">My account</a></li>
						<li><a href="${ctx }/contact.jsp">Address</a></li>
						<li><a href="${ctx }/checkout.jsp">wishlist</a></li>
						<li><a href="${ctx }/checkout.jsp">Order history</a></li>
