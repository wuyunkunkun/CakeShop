...
<body>
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<!-- 结账 -->
						...
						<p><a href="${ctx }/cake/deletecart4" class="simpleCart_empty">Empty cart</a></p>
				...
				<div class="product-grid">
					<a href="${ctx }/single.jsp">				
						...
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/${cake.img1 }" class="img-responsive" alt="">
							<div class="b-wrapper">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<div class="ofr">
								<p class="pric1"><del>${cake.discountprice }</del></p>
								<p class="disc">${cake.discount }</p>
							</div>
							<form action="${ctx }/cake/cart">
							<input type="text" class="item_quantity" value="1" name="num"/>
							<input type="hidden"  value=${cake.cakeId } name="cake" >
	...
	<div class="col-md-9 product-model-sec">
				<a href="${ctx }/cake/PageDivide?pageIndex=1">首页</a>&nbsp;&nbsp;
