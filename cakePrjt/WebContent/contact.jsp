			...
			<div class="header-info">
				...
				<div class="header-right cart">
					...
					<div class="cart-box">
						...
						<p><a href="${ctx }/cake/deletecart2" class="simpleCart_empty">Empty cart</a></p>
	...
	<div class="contact">
		<div class="container">
			...
			<div class="contact-form">
				<h4>Contact form</h4>
				<form action="${ctx }/user/idea">
					<input type="text" name = "userName" value="Name" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Name';}" required="">
					<input type="text" name = "userEmail" value="Email" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Email';}" required="">
					<input type="text" name = "userPhone"  value="Telephone" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Telephone';}" required="">
					<textarea type="text"  name = "userIdea" onfocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Message...';}" required="">Message...</textarea>
